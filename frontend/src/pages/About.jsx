    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
          <p>Welcome to <strong>Naza Collection</strong>, where elegance meets sophistication in every piece. Our brand is dedicated to curating a stunning range of fashion items that resonate with the modern individual. We believe that fashion is not just about clothing; it's an expression of your personality, a statement of your values, and a celebration of your unique style.</p>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenience:</b>
          <p>At <strong>Naza Collection</strong>, we aim to provide a seamless shopping experience with user-friendly navigation, fast shipping, easy returns, and 24/7 customer support. We ensure convenience at every step to make your shopping effortless and enjoyable.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Expectional Customer Service:</b>
          <p>At <strong>Naza Collection</strong>, we prioritize exceptional customer service by offering personalized support, quick responses, and ensuring customer satisfaction throughout your shopping journey.</p>
        </div>
      </div>
